...
try {
  if (fs.existsSync(BLOGS_FILE)) {
    ...
    blogs = [
      ...
      { id: 3, title: 'Now this... idk what this is', author: 'Onni Hölttä', url: 'https://github.com/Juoksumatto/Fullstack-5', likes: 2647 }
    ]
  }
} catch (error) {
...
const saveBlogs = () => {
  try {
    fs.writeFileSync(BLOGS_FILE, JSON.stringify(blogs, null, 3))
  } catch (error) {
